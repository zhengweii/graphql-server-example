...
export const reviews = [
  ...
  },
  {
    ...
    title: 'Terrible!!!!!!',
    comment:
      'Not good at all!! Used it once and got caught 2 days later. Now I am doing life without parole',
    rating: 1,
